...
class CustomUser(AbstractBaseUser, PermissionsMixin): 
    ...
    profile_picture = models.ImageField(verbose_name=_("Profile Picture"), upload_to='CustomUsers/ProfilePictures/', default='default_user_image/user-image.jpg', null=True, blank=True)
