...
urlpatterns = [
        ...
        # follow and unfollow 
        path('me/follow/<uuid:user_id>/', FollowAUserAPIView.as_view(), name='follow-a-user'), 
        path('me/unfollow/<uuid:user_id>/', UnfollowAUserAPIView.as_view(), name='unfollow-a-user')
]
