...
class ArticleFilter(FilterSet): 
        ...
        tags = filters.CharFilter(field_name='tags__name', lookup_expr='icontains') # for searcing, do not directly use foreignkey field, use  __fieldname convention to locate proper field from foreignkey
