...
class ProfileSerializer(serializers.ModelSerializer): 
        ...
        class Meta: 
                model = Profile
                fields = [
                        'profile_id', 'user_id', 'first_name', 'last_name', 'full_name', 'email', 'profile_photo', 'country', 'city', 'phone_number', 'gender', 'about_me', 'twitter_handle', 'total_followers'      
                ]
...
class UserDetailsProfileSerializer(serializers.ModelSerializer): 
        ...
        class Meta: 
                model = Profile 
                fields = ['gender', 'twitter_handle', 'phone_number', 'profile_photo', 'country', 'city', 'about_me', 'total_followers']
